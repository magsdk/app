...
// on smart rc pageUp=33, pageDown=34, on classic rc ChannelNext=33, ChannelPrev=34
// this can result in strange situation with unpredicted behavior
// so old key codes should be hidden
keys.pageDown     = -1;
keys.pageUp       = -1;
